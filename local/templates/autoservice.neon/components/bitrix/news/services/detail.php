...
<?php
global $faqFilter;
$arFilter = Array("IBLOCK_ID"=>18, 'ID'=>$ElementID);
$res = CIBlockElement::GetList(Array(), $arFilter, false, Array("nPageSize"=>50), array("PROPERTY_FAQ"));
while($ob = $res->GetNextElement()) {
    $arFields = $ob->GetFields();
    if ($arFields['PROPERTY_FAQ_VALUE'])
    $faqFilter['ID'][] = $arFields['PROPERTY_FAQ_VALUE'];
}
if ($faqFilter['ID']) {
?>
...
$portfolioFilter['PROPERTY_SERVICES'] = $ElementID;
?>
<?$APPLICATION->IncludeComponent(
    "bitrix:news.list",
    "portfolio",
