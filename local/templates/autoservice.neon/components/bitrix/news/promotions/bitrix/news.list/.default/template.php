            ...
            <div class="news_list_text_block">
                <?if($arItem["FIELDS"]["DATE_ACTIVE_FROM"]):?>
                    <?if($arItem["DATE_ACTIVE_TO"]):?>
                        <div class="news_list_date"><?=GetMessage("PRV_PROM_LIST_FROM");?> <?echo FormatDate('j F', MakeTimeStamp($arItem["DATE_ACTIVE_FROM"]));?> <?=GetMessage("PRV_PROM_LIST_TO");?> <?echo FormatDate('j F', MakeTimeStamp($arItem["DATE_ACTIVE_TO"]));?></div>
                    <?else:?>
                        <div class="news_list_date"><?echo FormatDate('j F', MakeTimeStamp($arItem["DATE_ACTIVE_FROM"]));?></div>
                    <?endif;?>
                <?endif?>
