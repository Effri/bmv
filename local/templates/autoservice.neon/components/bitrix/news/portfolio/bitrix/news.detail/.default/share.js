! function (e) {
    ...
    e.exports = function e() {
        var t, n, r, i, l, u, c = arguments[0],
            ...
            d = arguments.length,
            f = !1;
        for ("boolean" == typeof c && (f = c, c = arguments[1] || {}, p = 2), (null == c || "object" !== (void 0 === c ? "undefined" : o(c)) && "function" != typeof c) && (c = {}); p < d; ++p)
            if (null != (t = arguments[p]))
                for (n in t) r = c[n], i = t[n], c !== i && (f && i && (s(i) || (l = a(i))) ? (l ? (l = !1, u = r && a(r) ? r : []) : u = r && s(r) ? r : {}, c[n] = e(f, u, i)) : void 0 !== i && (c[n] = i));
        return c
    }
}, function (e, t, n) {
    "use strict";
    ...
    var r = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (e) {
        ...
        f = (0, s.loadPlugins)(),
        m = (0, s.getFrameUrl)(),
        h = new u.default(a.default.metrika.id),
    ...
    var i = n(1),
        ...
        m = n(13),
        h = o(m),
        v = new f.default(window.document),
        y = !1
}, function (e, t, n) {
    "use strict";
    ...
    var l = function () {
        ...
        M = function () {
            ...
            return l(e, [{
                ...
                value: function () {
                    var e = y.default.findInside(this._domNode, {
                        block: "ya-share2",
                        elem: "container"
                    })[0];
                ...
                value: function (e, t) {
                    var n = b.default.getTarget(t),
                        o = y.default.findOutside(n, {
                            block: "ya-share2",
                            elem: "container"
                        }),
                        r = y.default.findInside(this._domNode, {
                            block: "ya-share2",
                            elem: "container"
                        })[0];
                    if (!o || o !== r && o !== this._morePopupContainer) return void this._closePopup();
                    var i = y.default.findOutside(n, {
                        block: "ya-share2",
                        elem: "item"
                    });
                ...
                value: function (e) {
                    if ((0, _.copy)() ? this._morePopup.classList.add("ya-share2__popup_clipboard") : this._morePopup.classList.remove("ya-share2__popup_clipboard"), this._morePopupContainer) {
                        var t = y.default.findInside(this._domNode, {
                            ...
                            n = b.default.getRectRelativeToDocument(t),
                            o = n.top,
                            r = n.left,
                            i = n.width,
                            a = n.height;
                ...
                _html: function (e) {
                    ...
                    if (!1 !== e && null != e)
                        ...
                        var p, d, f, m = "",
                            ...
                            v = !1;
                        if (p = e.attrs)
                            for (t in p) d = p[t], !0 === d ? h += " " + t : !1 !== d && null !== d && void 0 !== d && (h += " " + t + '="' + r(d) + '"');
                        if (c) {
        ...
        ! function (i) {
            ...
            function h(e) {
                ...
                for (o = r = b.length, r && b.push(A); o < v;) {
                    ...
                    for (y = o + 1, l - t > U((x - n) / y) && a("overflow"), n += (l - t) * y, t = l, s = 0; s < v; ++s)
                        if (h = e[s], h < t && ++n > x && a("overflow"), h == t) {
            ...
            if (k = {
                ...
                if (e.exports == _) g.exports = k;
                else
                    for (w in k) k.hasOwnProperty(w) && (_[w] = k[w]);
            else i.punycode = k
        }(void 0)
    }).call(t, n(72)(e))
}, function (e, t, n) {
    ...
    function l(e, t) {
        ...
        return Object.keys(e).forEach(function (o) {
            var r = e[o];
            if ("object" === (void 0 === r ? "undefined" : c(r)) && null !== r)
