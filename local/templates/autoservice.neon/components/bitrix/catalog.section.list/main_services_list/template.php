...
?>
<section id="main_services" class="black_section">
    <div class="main_services_backgroud"></div>
    <div class="container">
        <h2 class="main_header"><?$APPLICATION->IncludeComponent(
            ...
            Array(
                ...
                "EDIT_TEMPLATE" => "",
                "PATH" => str_replace("//", "/", SITE_DIR . "/inc/services_main_list.php")
            )
        );?></h2>
        <?
        ...
        {
        ?>
        <div class="row service_main_container">
            <?
            switch ($arParams['VIEW_MODE'])
            {
                ...
                case 'TILE':
                    foreach ($arResult['SECTIONS'] as $key => &$arSection)
                    {
                        ...
                        switch ($key) {
                            case 0:
                                $col = 'col-12 col-sm-12 col-md-12 col-lg-8 col-xl-6';
                                break;
                            case 1:
                                $col = 'col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3';
                                break;
                            case 2:
                        ...
                        ?>
                        <div class="<?echo $col;?> one_item_serv" id="<?=$this->GetEditAreaId($arSection['ID']);?>">
